...
| [MCP_SETUP.md](./MCP_SETUP.md) | Grok professor PAT at `/api/mcp` |

## Leftover in this fork

Commerce routes redirect to `/dashboard`. Payment APIs return 410. These files still exist. Do not treat them as operator how-tos for BotEducation.

| Doc | What it covered upstream |
|--|--|
...
- **Connect a Grok professor?** → [MCP_SETUP.md](./MCP_SETUP.md)
